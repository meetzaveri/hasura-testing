...
CREATE TABLE public.articles (
    ...
    title text NOT NULL,
    content text DEFAULT 'ABC'::text NOT NULL,
...
CREATE FUNCTION public.filter_author_articles(author_row public.authors, search text) RETURNS SETOF public.articles
    LANGUAGE sql STABLE
    AS $$
  SELECT *
